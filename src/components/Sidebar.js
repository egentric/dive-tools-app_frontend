      ...
      <Navbar expand="lg" className="menuGauche flex-column">
        ...
        <Nav className="menuGauche flex-column">
          <ul>
            ...
            <li className="menu d-none d-md-inline">
              <div className="materiels"> MATERIELS :</div>
              <ul>
                <li>
                  <Nav.Link href="/reservations/add" className="menuG">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="25"
                      height="25"
                    ...
                    <span className="menu d-none d-md-inline">Réservation</span>
                  </Nav.Link>
                </li>
                {role === 1 || role === 2 ? (
                  <>
                    <li>
                      <Nav.Link href="/tanks" className="menuG">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="30"
                          height="30"
                    ...
                    <li>
                      <Nav.Link href="/bcds" className="menuG">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="25"
                          height="25"
                    ...
                    <li>
                      <Nav.Link href="/regulators" className="menuG">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="30"
                          height="30"
