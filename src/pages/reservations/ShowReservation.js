                  ...
                  <Table striped bordered hover>
                    <tbody>
                      ...
                      <tr>
                        <th>Emprunteur</th>
                        <td>
                          {showReservation.lastname} {showReservation.firstname}
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>{formatDateShow(showReservation.return_date)}</td>
                      </tr>
                      <tr>
                        <th>Détendeur</th>
                      ...
                      <tr>
                        <th>Stab</th>
                        <td>{showReservation.code_BCD}</td>
                      </tr>

                      <tr>
                        <th>Taille Stab</th>
                        <td>{showReservation.size_BCD}</td>
                      </tr>
                        ...
                        <td>
                          <ul>
                            {showReservation.tankss.map((tank) => (
                              <li key={tank.id}>{tank.code_tank}</li>
                            ))}
                          </ul>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <ul>
                            {showReservation.tankss.map((tank) => (
                              <li key={tank.id}>{tank.capacity_tank} litres</li>
                            ))}
                          </ul>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <ul>
                            {showReservation.tankss.map((tank) => (
                              <li key={tank.id}>{tank.gas_tank}</li>
                            ))}
                          </ul>
                        </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td>{formatDateShow2(showReservation.created_at)}</td>
                      </tr>
                      <tr>
                        <th>Date de modification</th>
                        <td>{formatDateShow2(showReservation.updated_at)}</td>
                      </tr>
                      <tr>
                        <th>Actions</th>
                        <td>
                          ...
                          <Link
                            to={`/bcds/edit/${showReservation.id}`}
